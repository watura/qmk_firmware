...
[_QWERTY] = LAYOUT( \
  ...
  KC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC, KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC, \
          KC_LGUI, LOWER, KC_LALT,  LSANDS, LT(LOWER,KC_ENT), LT(RAISE,KC_BSPC), RSANDS, KC_RALT, RAISE, KC_RGUI\
),
...
[_LOWER] = LAYOUT( \
  ...
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_QUOTE, _______,  KC_F12,  KC_NUHS, KC_NUBS, _______, _______, _______, \
                    _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______\
),
