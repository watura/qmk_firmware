...
[_LOWER] = LAYOUT( \
  ...
  KC_DEL,  _______, _______, _______, _______, KC_GRAVE,                  KC_QUOTE, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, KC_PIPE, \
  _______, _______, _______, _______, _______, _______, _______, _______, KC_DQUO, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_NUBS, \
...
[_RAISE] = LAYOUT( \
  ...
  _______, KC_LEFT, KC_DOWN, KC_RIGHT,_______, _______,                   _______, KC_LANG1,_______, _______, KC_LANG2,_______, \
